...
export const handleNavigation = (locationData) => {
  ...
  btnTwo.innerText = locationData.buttons[1].text;
  btnThree.innerText = locationData.buttons[2].text;
  btnFour.innerText = locationData.buttons[3].text;
  btnOne.onclick = locationData.buttons[0].function;
  btnTwo.onclick = locationData.buttons[1].function;
...
export const handleSecondaryControls = (secondaryOptions) => {
  ...
  secondaryBtnFour.innerText = secondaryOptions[3].text;
  secondaryBtnOne.onclick = secondaryOptions[0].function;
  secondaryBtnTwo.onclick = secondaryOptions[1].function;
  secondaryBtnThree.onclick = secondaryOptions[2].function;
  secondaryBtnFour.onclick = secondaryOptions[3].function;
};
...
addEventListener("load", () => {
  handleNavigation(locationData.sonirStart);
